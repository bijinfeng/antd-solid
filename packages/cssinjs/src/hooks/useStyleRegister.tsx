...
import { removeCSS, updateCSS } from '@antd-solidjs/util/dom/dynamicCSS';
...
export function normalizeStyle(styleStr: string, autoPrefix: boolean): string {
...
// ==                                Register                                ==
// ============================================================================
export function uniqueHash(path: (string | number)[], styleStr: string): string {
