import { createContext, useContext, createMemo, type Component, Context } from 'solid-js';
...
export function createCache(): CacheEntity {
...
const StyleContext: Context<StyleContextProps> = createContext<StyleContextProps>({
  hashPriority: 'low',
  cache: createCache(),
  defaultCache: true,
  autoPrefix: false,
