...
import { genStyleUtils, type GetCompUnitless } from '@antd-solidjs/cssinjs-utils';
...
export const { genComponentStyleHook, genStyleHooks, genSubStyleComponent } = genStyleUtils<ComponentTokenMap, AliasToken, SeedToken>({
  usePrefix: () => {
