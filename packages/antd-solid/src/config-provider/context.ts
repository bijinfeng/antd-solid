...
type GetClassNamesOrEmptyObject<Config extends ComponentStyleConfig> = Config extends {
  classNames?: infer ClassNames;
}
  ? ClassNames
  : object;

type GetStylesOrEmptyObject<Config extends ComponentStyleConfig> = Config extends {
  styles?: infer Styles;
}
  ? Styles
  : object;
