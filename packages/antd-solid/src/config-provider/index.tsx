...
import { createTheme, StyleContext as CssInJsStyleContext } from '@antd-solidjs/cssinjs';
...
const ProviderChildren: Component<ProviderChildrenProps> = (props) => {
  ...
  if (config.warning) {
    childNode = (
      <WarningContext.Provider value={config.warning}>{childNode}</WarningContext.Provider>
    );
  }
