...
const Empty: Component = () => {
  ...
  const themeStyle: JSX.CSSProperties = bgColor.toHsl().l < 0.5 ? { opacity: 0.65 } : {};
    ...
    >
      ...
      <g fill="none" fill-rule="evenodd">
        <g transform="translate(24 31.7)">
          <ellipse fill-opacity=".8" fill="#F5F5F7" cx="67.8" cy="106.9" rx="67.8" ry="12.7" />
          <path
            fill="#aeb8c2"
        ...
        />
        <g fill="#fff" transform="translate(149.7 15.4)">
