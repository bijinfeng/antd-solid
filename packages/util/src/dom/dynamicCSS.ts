...
function syncRealContainer(container: ContainerType, option: Options) {
  ...
  if (!cachedRealContainer || !contains(document, cachedRealContainer)) {
    ...
    containerCache.set(container, placeholderStyle?.parentNode as ParentNode);
    container.removeChild(placeholderStyle as Node);
  }
}
...
export function updateCSS(
  ...
  const newNode = injectCSS(css, option) as HTMLStyleElement;
