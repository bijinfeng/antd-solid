...
import MobileTwoToneSvg from '@ant-design/icons-svg/es/asn/MobileTwoTone.js'
...
const MobileTwoTone: Component<AntdIconProps> = (props) => <AntdIcon {...props} icon={MobileTwoToneSvg} />;
