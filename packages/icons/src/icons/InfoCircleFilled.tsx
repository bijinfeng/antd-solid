...
import InfoCircleFilledSvg from '@ant-design/icons-svg/es/asn/InfoCircleFilled.js'
...
const InfoCircleFilled: Component<AntdIconProps> = (props) => <AntdIcon {...props} icon={InfoCircleFilledSvg} />;
