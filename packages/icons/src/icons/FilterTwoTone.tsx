...
import FilterTwoToneSvg from '@ant-design/icons-svg/es/asn/FilterTwoTone.js'
...
const FilterTwoTone: Component<AntdIconProps> = (props) => <AntdIcon {...props} icon={FilterTwoToneSvg} />;
