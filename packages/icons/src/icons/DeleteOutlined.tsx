...
import DeleteOutlinedSvg from '@ant-design/icons-svg/es/asn/DeleteOutlined.js'
...
const DeleteOutlined: Component<AntdIconProps> = (props) => <AntdIcon {...props} icon={DeleteOutlinedSvg} />;
