...
import UploadOutlinedSvg from '@ant-design/icons-svg/es/asn/UploadOutlined.js'
...
const UploadOutlined: Component<AntdIconProps> = (props) => <AntdIcon {...props} icon={UploadOutlinedSvg} />;
