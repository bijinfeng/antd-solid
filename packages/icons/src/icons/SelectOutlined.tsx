...
import SelectOutlinedSvg from '@ant-design/icons-svg/es/asn/SelectOutlined.js'
...
const SelectOutlined: Component<AntdIconProps> = (props) => <AntdIcon {...props} icon={SelectOutlinedSvg} />;
