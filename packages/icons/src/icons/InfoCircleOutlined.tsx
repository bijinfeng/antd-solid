...
import InfoCircleOutlinedSvg from '@ant-design/icons-svg/es/asn/InfoCircleOutlined.js'
...
const InfoCircleOutlined: Component<AntdIconProps> = (props) => <AntdIcon {...props} icon={InfoCircleOutlinedSvg} />;
