...
import MinusCircleOutlinedSvg from '@ant-design/icons-svg/es/asn/MinusCircleOutlined.js'
...
const MinusCircleOutlined: Component<AntdIconProps> = (props) => <AntdIcon {...props} icon={MinusCircleOutlinedSvg} />;
