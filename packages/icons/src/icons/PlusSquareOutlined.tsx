...
import PlusSquareOutlinedSvg from '@ant-design/icons-svg/es/asn/PlusSquareOutlined.js'
...
const PlusSquareOutlined: Component<AntdIconProps> = (props) => <AntdIcon {...props} icon={PlusSquareOutlinedSvg} />;
