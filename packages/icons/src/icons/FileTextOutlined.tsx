...
import FileTextOutlinedSvg from '@ant-design/icons-svg/es/asn/FileTextOutlined.js'
...
const FileTextOutlined: Component<AntdIconProps> = (props) => <AntdIcon {...props} icon={FileTextOutlinedSvg} />;
