...
import AudioFilledSvg from '@ant-design/icons-svg/es/asn/AudioFilled.js'
...
const AudioFilled: Component<AntdIconProps> = (props) => <AntdIcon {...props} icon={AudioFilledSvg} />;
