...
import PictureOutlinedSvg from '@ant-design/icons-svg/es/asn/PictureOutlined.js'
...
const PictureOutlined: Component<AntdIconProps> = (props) => <AntdIcon {...props} icon={PictureOutlinedSvg} />;
