...
import FireOutlinedSvg from '@ant-design/icons-svg/es/asn/FireOutlined.js'
...
const FireOutlined: Component<AntdIconProps> = (props) => <AntdIcon {...props} icon={FireOutlinedSvg} />;
