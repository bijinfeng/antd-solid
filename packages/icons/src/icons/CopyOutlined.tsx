...
import CopyOutlinedSvg from '@ant-design/icons-svg/es/asn/CopyOutlined.js'
...
const CopyOutlined: Component<AntdIconProps> = (props) => <AntdIcon {...props} icon={CopyOutlinedSvg} />;
