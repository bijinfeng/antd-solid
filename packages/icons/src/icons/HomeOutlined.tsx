...
import HomeOutlinedSvg from '@ant-design/icons-svg/es/asn/HomeOutlined.js'
...
const HomeOutlined: Component<AntdIconProps> = (props) => <AntdIcon {...props} icon={HomeOutlinedSvg} />;
