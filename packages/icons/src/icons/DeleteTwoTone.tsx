...
import DeleteTwoToneSvg from '@ant-design/icons-svg/es/asn/DeleteTwoTone.js'
...
const DeleteTwoTone: Component<AntdIconProps> = (props) => <AntdIcon {...props} icon={DeleteTwoToneSvg} />;
