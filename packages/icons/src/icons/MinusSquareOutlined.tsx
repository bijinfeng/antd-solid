...
import MinusSquareOutlinedSvg from '@ant-design/icons-svg/es/asn/MinusSquareOutlined.js'
...
const MinusSquareOutlined: Component<AntdIconProps> = (props) => <AntdIcon {...props} icon={MinusSquareOutlinedSvg} />;
